...
## Every year, many patients with diabetes return to the hospital shortly after being discharged—often when it could have been prevented.

## Hospital readmissions within 30 days are a major challenge for healthcare providers, especially when caring for patients with chronic conditions like diabetes. These readmissions can indicate complications, gaps in follow-up care, or difficulty managing health after leaving the hospital. Despite tracking readmission rates, hospitals often struggle to identify which patients are most at risk. This project focuses on identifying patterns in hospital data that are associated with 30-day readmission among diabetic patients.
...
## 
<img width="474" height="450" alt="Screenshot 2026-03-28 at 10 12 39 AM" src="https://github.com/user-attachments/assets/96aa85a3-557e-46f0-8268-55514cd233b1" />
